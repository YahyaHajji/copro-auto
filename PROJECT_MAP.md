...
- [ ] Déployer réellement le MVP HTTPS sur Vercel Hobby et Neon Free. Le point d'entrée FastAPI, la procédure et le limiteur PostgreSQL commun aux instances serverless sont prêts et testés. Le formulaire Neon est préparé pour PostgreSQL 18 à Francfort; restent la création des ressources, l'injection des secrets et le smoke test distant.
